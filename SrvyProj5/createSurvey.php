...
<p><span id="titlename"></span></p>
 ...
 <form action = "createSurvey.html" method ="get" style="border: solid 2px blue">
    ...
    var title = null;
           ...
           // get and display user added new questions
            ...
            for (var i = 1; i <= len; i++) {
                ...
                question.display();
                document.write('<button id="btn" onclick="deleteFunction(\''  + i + '\')">Delete</button>');
            }
            ...
            function deleteFunction(num){
                ...
                document.getElementById("btn").innerHTML = "Already deleted!";
